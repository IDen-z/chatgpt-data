package com.zmz.chatgpt.data.infrastructure.repository;

import com.zmz.chatgpt.data.domain.order.model.aggregates.CreateOrderAggregate;
import com.zmz.chatgpt.data.domain.order.model.entity.*;
import com.zmz.chatgpt.data.domain.order.model.valobj.OrderStatusVO;
import com.zmz.chatgpt.data.domain.order.model.valobj.PayStatusVO;
import com.zmz.chatgpt.data.domain.order.repository.IOrderRepository;
import com.zmz.chatgpt.data.infrastructure.dao.IOpenAIOrderDao;
import com.zmz.chatgpt.data.infrastructure.dao.IOpenAIProductDao;
import com.zmz.chatgpt.data.infrastructure.dao.IUserAccountDao;
import com.zmz.chatgpt.data.infrastructure.po.OpenAIOrderPO;
import com.zmz.chatgpt.data.infrastructure.po.OpenAIProductPO;
import com.zmz.chatgpt.data.infrastructure.po.UserAccountPO;
import com.zmz.chatgpt.data.types.enums.OpenAIProductEnableModel;
